...
from rotkehlchen.assets.asset import AssetWithSymbol, AssetWithSymbolAndCryptoOracles, EvmToken
...
def pair_get_assets(pair: TradePair) -> Tuple[AssetWithSymbolAndCryptoOracles, AssetWithSymbolAndCryptoOracles]:
