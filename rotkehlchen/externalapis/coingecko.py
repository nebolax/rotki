...
class Coingecko(HistoricalPriceOracleInterface):
    ...
    def asset_data(self, asset: AssetWithSymbolAndCryptoOracles) -> CoingeckoAssetData:
        """
    ...
    def check_vs_currencies(
            from_asset: AssetWithSymbolAndCryptoOracles,
            to_asset: AssetWithSymbolAndCryptoOracles,
            location: str,
    ) -> Optional[str]:
    ...
    def query_current_price(self, from_asset: Asset, to_asset: Asset) -> Price:
        ...
        """
        try:
            from_asset = from_asset.resolve_to_symbol_and_oracles_asset()
            to_asset = to_asset.resolve_to_symbol_and_oracles_asset()
