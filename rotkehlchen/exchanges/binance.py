...
class Binance(ExchangeInterface):  # lgtm[py/missing-call-to-init]
    ...
    def _query_spot_balances(
            self,
            balances: DefaultDict[AssetWithSymbolAndCryptoOracles, Balance],
    ) -> DefaultDict[AssetWithSymbolAndCryptoOracles, Balance]:
    ...
    def _query_margined_fapi(self, balances: DefaultDict[AssetWithSymbolAndCryptoOracles, Balance]) -> DefaultDict[AssetWithSymbolAndCryptoOracles, Balance]:  # noqa: E501
    ...
    def _query_margined_dapi(self, balances: DefaultDict[AssetWithSymbolAndCryptoOracles, Balance]) -> DefaultDict[AssetWithSymbolAndCryptoOracles, Balance]:  # noqa: E501
        """Only a convenience function to give same interface as other query methods"""
    ...
    def query_balances(self) -> ExchangeQueryBalances:
        try:
            self.first_connection()
            returned_balances: DefaultDict[AssetWithSymbolAndCryptoOracles, Balance] = defaultdict(Balance)
