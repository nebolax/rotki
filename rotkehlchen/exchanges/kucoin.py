...
def deserialize_trade_pair(trade_pair_symbol: str) -> Tuple[AssetWithSymbolAndCryptoOracles, AssetWithSymbolAndCryptoOracles]:
    """May raise:
...
class Kucoin(ExchangeInterface):  # lgtm[py/missing-call-to-init]
    ...
    ) -> Dict[AssetWithSymbolAndCryptoOracles, Balance]:
        """May raise RemoteError
        """
        try:
