...
def bitcoinde_asset(symbol: str) -> AssetWithSymbolAndCryptoOracles:
    return symbol_to_asset_or_token(symbol.upper())


def bitcoinde_pair_to_world(pair: str) -> Tuple[AssetWithSymbolAndCryptoOracles, AssetWithSymbolAndCryptoOracles]:
    if len(pair) == 6:
...
class Bitcoinde(ExchangeInterface):  # lgtm[py/missing-call-to-init]
    ...
    def query_balances(self, **kwargs: Any) -> ExchangeQueryBalances:
        assets_balance: Dict[AssetWithSymbolAndCryptoOracles, Balance] = {}
        try:
