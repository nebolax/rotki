...
from rotkehlchen.assets.asset import AssetWithSymbol, AssetWithSymbolAndCryptoOracles, CryptoAsset, FiatAsset
...
class Bitpanda(ExchangeInterface):  # lgtm[py/missing-call-to-init]
    ...
    def __init__(
        ...
        self.cryptocoin_map: Dict[str, AssetWithSymbolAndCryptoOracles] = {}
        # AssetWithSymbolAndCryptoOracles instead of FiatAsset to comply with cryptocoin_map
        self.fiat_map: Dict[str, AssetWithSymbolAndCryptoOracles] = {}
    ...
    def query_balances(self) -> ExchangeQueryBalances:
        ...
        assets_balance: DefaultDict[AssetWithSymbolAndCryptoOracles, Balance] = defaultdict(Balance)
        wallets_len = len(wallets)
        for idx, entry in enumerate(wallets + fiat_wallets):
