...
class BinanceTradeEntry(BinanceMultipleEntry):
    ...
    def process_trades(
        ...
        # Checking assets
        same_assets = True
        assets: Dict[str, Optional[AssetWithSymbolAndCryptoOracles]] = defaultdict(lambda: None)
        for row in data:
        ...
        for trade_rows in grouped_trade_rows:
            to_asset: Optional[AssetWithSymbolAndCryptoOracles] = None
            to_amount: Optional[AssetAmount] = None
            from_asset: Optional[AssetWithSymbolAndCryptoOracles] = None
            from_amount: Optional[AssetAmount] = None
            fee_asset: Optional[AssetWithSymbolAndCryptoOracles] = None
