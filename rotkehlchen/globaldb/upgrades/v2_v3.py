...
def migrate_to_v3(connection: 'DBConnection') -> None:
    ...
    with connection.write_ctx() as cursor:
        ...
        CREATE TABLE IF NOT EXISTS assets (
            ...
            started INTEGER,
            swapped_for TEXT,
            FOREIGN KEY(swapped_for) REFERENCES assets(identifier) ON UPDATE CASCADE ON DELETE CASCADE
        );
        """)  # noqa: E501
        cursor.execute("""
        CREATE TABLE IF NOT EXISTS common_asset_details(
            ...
            cryptocompare TEXT,
            forked TEXT,
            FOREIGN KEY(forked) REFERENCES assets(identifier) ON UPDATE CASCADE ON DELETE CASCADE,
