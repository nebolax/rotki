...
from .asset import AssetWithSymbol, AssetWithSymbolAndCryptoOracles, CryptoAsset, EvmToken, UnderlyingToken
...
) -> Optional[AssetWithSymbolAndCryptoOracles]:
...
def symbol_to_asset_or_token(symbol: str) -> AssetWithSymbolAndCryptoOracles:
    ...
    """
    asset: AssetWithSymbolAndCryptoOracles
    try:
        asset = Asset(symbol)
    except UnknownAsset:
