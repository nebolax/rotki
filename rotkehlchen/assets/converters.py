...
from rotkehlchen.assets.asset import (
    ...
    WORLD_TO_POLONIEX,
    WORLD_TO_UPHOLD,
    AssetWithSymbolAndCryptoOracles,
)
...
def asset_from_kraken(kraken_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
...
def asset_from_poloniex(poloniex_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_bitstamp(bitstamp_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_bittrex(bittrex_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_coinbasepro(coinbase_pro_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_binance(binance_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_coinbase(cb_name: str, time: Optional[Timestamp] = None) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnknownAsset
    """
...
def asset_from_ftx(ftx_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_kucoin(kucoin_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_gemini(symbol: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_iconomi(symbol: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_uphold(symbol: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_nexo(nexo_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_bitpanda(bitpanda_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
def asset_from_cryptocom(cryptocom_name: str) -> AssetWithSymbolAndCryptoOracles:
    """May raise:
    - DeserializationError
    - UnsupportedAsset
    - UnknownAsset
...
LOCATION_TO_ASSET_MAPPING: Dict[Location, Callable[[str], AssetWithSymbolAndCryptoOracles]] = {
