...
def test_booster_deposit(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0xC960338B529e0353F570f62093Fd362B8FB55f0B',
            notes='Send 3.996511863643743872 steCRV from 0xC960338B529e0353F570f62093Fd362B8FB55f0B to 0x989AEb4d175e16225E39E87d0D97A3360524AD80',  # noqa: E501
...
def test_booster_withdraw(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x53913A03a065f685097f8E8f40284D58016bB0F9',
            notes='Send 364.338089842514973505 cvxcvxFXSFXS-f from 0x53913A03a065f685097f8E8f40284D58016bB0F9 to 0x0000000000000000000000000000000000000000',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ), HistoryBaseEntry(
            ...
            balance=Balance(amount=FVal('364.338089842514973505'), usd_value=ZERO),
            location_label='0x53913A03a065f685097f8E8f40284D58016bB0F9',
            notes='Receive 364.338089842514973505 cvxFXSFXS-f from 0xF403C135812408BFbE8713b5A23a04b3D48AAE31 to 0x53913A03a065f685097f8E8f40284D58016bB0F9',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_cvxcrv_get_reward(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',
            notes='Receive 860.972070701362256315 CRV from 0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e to 0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ), HistoryBaseEntry(
            ...
            location_label='0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',
            notes='Receive 73.182626009615791786 CVX from 0x0000000000000000000000000000000000000000 to 0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ), HistoryBaseEntry(
            ...
            location_label='0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',
            notes='Receive 587.269770914653758937 3Crv from 0x7091dbb7fcbA54569eF1387Ac89Eb2a5C9F6d2EA to 0xFb305A40Dac406BdCF3b85F6311e5430770f44bA',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_cvxcrv_withdraw(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0xe81FC42336c9314A9Be1EDB3F50eA9e275C93df3',
            notes='Receive 15719.844875963195659251 cvxCRV from 0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e to 0xe81FC42336c9314A9Be1EDB3F50eA9e275C93df3',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_cvxcrv_stake(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x2AcEcBF2Ee5BFc8eed599D58835EE9A7c45F3E2c',
            notes='Send 166.415721340864759482 cvxCRV from 0x2AcEcBF2Ee5BFc8eed599D58835EE9A7c45F3E2c to 0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ), HistoryBaseEntry(
...
def test_cvx_stake(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x5B186c93A50D3CB435fE2933427d36E6Dc688e4b',
            notes='Send 1 CVX from 0x5B186c93A50D3CB435fE2933427d36E6Dc688e4b to 0xCF50b810E57Ac33B91dCF525C6ddd9881B139332',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ), HistoryBaseEntry(
...
def test_cvx_get_reward(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x95c5582D781d507A084c9E5f885C77BabACf8EeA',
            notes='Receive 31.768689199711000544 cvxCRV from 0xCF50b810E57Ac33B91dCF525C6ddd9881B139332 to 0x95c5582D781d507A084c9E5f885C77BabACf8EeA',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_cvx_withdraw(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x84BCE169c271e1c1777715bb0dd38Ad9e6381BAa',
            notes='Receive 550.028156587407675374 CVX from 0xCF50b810E57Ac33B91dCF525C6ddd9881B139332 to 0x84BCE169c271e1c1777715bb0dd38Ad9e6381BAa',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_claimzap_abracadabras(database, ethereum_manager, eth_transactions):
    ...
    # receipt = eth_transactions.get_or_query_transaction_receipt(tx_hash=evmhash)
    # receipt.logs = receipt.logs[-2:-1]
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x999EcCEa3C4f9219B1B1B42b4830e62c26004B40',
            notes='Receive 118.309589873153954467 CVX from 0x3Ba207c25A278524e1cC7FaAea950753049072A4 to 0x999EcCEa3C4f9219B1B1B42b4830e62c26004B40',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
...
def test_claimzap_cvx_locker(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            location_label='0x0C3Cc503EaE928Ed6B5b01B8a9EE8de2855d03Ac',
            notes='Receive 177.668241365710099244 cvxCRV from 0xD18140b4B819b895A3dba5442F959fA44994AF50 to 0x0C3Cc503EaE928Ed6B5b01B8a9EE8de2855d03Ac',  # noqa: E501
            counterparty=CPT_CONVEX,
            identifier=None,
            extra_data=None,
        ),
